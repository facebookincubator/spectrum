...
public class JniEncodeOptionsTest extends BaseJniOptionsTest {
  ...
  public void test_whenGiven_thenEqualsReturned() {
    final EncodeOptions original =
        EncodeOptions.Builder(TEST_ENCODE_REQUIREMENT)
  ...
  @DoNotStrip
  private native Options loopback(final EncodeOptions encodeOptions);
}
