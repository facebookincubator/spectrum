...
public class JniDecodeOptionsTest extends BaseJniOptionsTest {
  ...
  public void test_whenGiven_thenEqualsReturned() {
    final DecodeOptions original =
        DecodeOptions.Builder(ImagePixelSpecification.RGB)
  ...
  @DoNotStrip
  private native Options loopback(final DecodeOptions decodeOptions);
}
